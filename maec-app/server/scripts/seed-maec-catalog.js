...
const SERVICES = [
  { code: 'SVC-AUTOREF',         name: 'Chụp khúc xạ tự động (+ đo số kính cũ nếu có)', category: 'khucxa',     station: 'auto-ref',         role: 'ktv-khuc-xa', devices: ['Auto-refractor'] },
  { code: 'SVC-REFRACT',         name: 'Đo khúc xạ (VA + chủ quan trial frame + khách quan SBĐT dry + PD)', category: 'khucxa',     station: 'va-refraction',    role: 'ktv-khuc-xa', devices: ['Trial frame + lens', 'VA chart'] },
  { code: 'SVC-TG2M',            name: 'Đo thị giác hai mắt (alignment + fusion + lập thể + biên độ điều tiết)', category: 'khucxa',     station: 'tg2m',             role: 'ktv-khuc-xa', devices: ['Worth 4-dot', 'Maddox', 'Prism bar'] },
  { code: 'SVC-CYCLO',           name: 'Liệt điều tiết + đo khúc xạ liệt điều tiết (45-min wait + wet SBĐT)', category: 'khucxa',     station: 'cyclo-room',       role: 'ktv-khuc-xa', devices: ['Cycloplegic drops', 'Trial frame'] },
  { code: 'SVC-CONTRAST',        name: 'Đo độ tương phản',                                category: 'khucxa',     station: 'contrast',         role: 'ktv',         devices: ['Pelli-Robson chart'] },
  { code: 'SVC-ISHIHARA',        name: 'Đo sắc giác (Ishihara)',                          category: 'khucxa',     station: 'color-vision',     role: 'ktv',         devices: ['Ishihara plates'] },
  { code: 'SVC-IOP',             name: 'Đo nhãn áp (iCare + Goldmann confirm khi bất thường)', category: 'iop-shv',     station: 'iop-portable',     role: 'ktv',         devices: ['iCare', 'Goldmann'] },
  { code: 'SVC-SLIT',            name: 'Khám sinh hiển vi (multi-event: initial + conclusion + [ortho-K] CL eval)', category: 'iop-shv',     station: 'slit-lamp',        role: 'bs',          devices: ['Slit lamp', '90D / 78D'] },
  { code: 'SVC-BIO',             name: 'Soi đáy mắt bằng BIO (indirect ophthalmoscopy)',  category: 'iop-shv',     station: 'bio',              role: 'bs',          devices: ['Indirect ophthalmoscope', '20D lens'] },
  { code: 'SVC-SCHIRMER',        name: 'Test Schirmer',                                   category: 'iop-shv',     station: 'schirmer',         role: 'ktv',         devices: ['Schirmer strips'] },
  { code: 'SVC-TOPO',            name: 'Bản đồ giác mạc',                                 category: 'imaging',    station: 'topo',             role: 'ktv',         devices: ['Medmont'] },
  { code: 'SVC-OCT-ANT',         name: 'OCT bán phần trước (+ pachymetry)',               category: 'imaging',    station: 'oct',              role: 'ktv',         devices: ['Optopol Revo'] },
  { code: 'SVC-OCT-POST',        name: 'OCT bán phần sau (RNFL + macula + ONH)',          category: 'imaging',    station: 'oct',              role: 'ktv',         devices: ['Optopol Revo'] },
  { code: 'SVC-FUNDUS',          name: 'Chụp đáy mắt',                                    category: 'imaging',    station: 'fundus',           role: 'ktv',         devices: ['DRS Plus (Trung Kính)', 'Vietcan {model TBD} (Kim Giang)'] },
  { code: 'SVC-DRYEYE',          name: 'Đánh giá khô mắt',                                category: 'imaging',    station: 'dry-eye',          role: 'ktv',         devices: ['IDRA', 'Medmont Meridia'] },
  { code: 'SVC-BIOMETRY',        name: 'Sinh trắc nhãn cầu (IOL biometry)',               category: 'imaging',    station: 'biometry',         role: 'ktv',         devices: ['MediWorks AB800', 'Syseye', 'Optopol Revo'] },
  { code: 'SVC-CL-FIT',          name: 'Thử kính tiếp xúc (gộp chốt đơn) — soft / RGP / ortho-K', category: 'cl',         station: 'cl-fit',           role: 'bs-cl',       devices: ['Trial CL kit', 'Slit lamp'] },
  { code: 'SVC-MYOPIA-CONSULT',  name: 'Tư vấn kiểm soát cận thị (placeholder, chưa bill riêng)', category: 'cl',         station: 'consult',          role: 'bs',          devices: [] },
  { code: 'SVC-FB-REMOVE',       name: 'Lấy dị vật kết / giác mạc',                       category: 'thuthuat',   station: 'procedure',        role: 'bs',          devices: ['Slit lamp', 'Sterile needle'] },
]
